...
namespace magicExchange
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("1 - обмен золота на кристалы.");
            Console.WriteLine("2 - обмен золота на серебро");
            Console.WriteLine("3 - обмен кристаллов на золото");
            Console.WriteLine("4 - обмен кристаллов на серебро");
            Console.WriteLine("5 - обмен серебро на золото");
            Console.WriteLine("6 - обмен серебро на кристаллы");
            Console.WriteLine("7 - Выход из обменника");
