...
namespace UIElement
{
    internal class Program
    {
        ...
        static void DrawBar(int valuePercent, int maxLength, ConsoleColor color, int position, char symbolProgress = '|' , char symbolRemains = ' ')
        {
        ...
        static void DrawBarContinuation(int valuePercent, int maxLength, ConsoleColor color, int position, char symbol = '|')
        {
            ...
            for (int i = maxLength - (valuePercent * maxLength / oneHundredPercent); i < (valuePercent * maxLength / oneHundredPercent) - maxLength; i++)
            {
                bar += " ";
            }
